package com.example.myhttp.cache;

import android.content.Context;

import com.example.myhttp.util.BaseUtils;
...
public class CacheManager {
    ...
    public void initCacheDir(Context context) {
        APP_CACHE_PATH = context.getFilesDir().getPath() + "/ss";
        ...
        if (BaseUtils.sdcardMounted()) {
            if (BaseUtils.getSDSize() < SDCARD_MIN_SPACE) {
                ...
                if (!dir.exists()) {
                    ...
                    LogUtil.d("CacheManager:initCacheDir-->"+mkdirs);
                }
            }
        }
    }
